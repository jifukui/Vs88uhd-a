...
var OutputHDCPAbility=[0,0,0,0,0,0,0,0];
var InputHDCPAbility=[0,0,0,0,0,0,0,0];
...
var inputActionClick = function (action, index) {
    ...
    if (action == 0) // 设置标题名或者切换模式
    {
        ...
        $("#signalhdcp").val(parseInt(InputHDCPAbility[index])); //InputHDCPAbility[index]
...
var routing_init_sync_queries = function () {
    ...
    refreshCommands();
    //setTimeout(GetroutingLabel,2000);
    GetroutingLabel();
};
